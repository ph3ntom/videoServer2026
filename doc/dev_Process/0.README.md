...
5. **[v0.5 - 태그 시스템](./6.v0.5-tag-system.md)** ⭐ NEW
   - 태그 CRUD 및 검색
   - 비디오-태그 다대다 관계
   - 새 태그 생성 모달 (색상 커스터마이징)
   - 태그별 비디오 필터링
...
| GET | `/api/v1/tags/search?q=` | ❌ | 태그 검색 |
...
| POST | `/api/v1/videos/{id}/tags` | ✅ | 태그 추가 |
| PUT | `/api/v1/videos/{id}/tags` | ✅ | 태그 전체 교체 |
| DELETE | `/api/v1/videos/{id}/tags/{tag_id}` | ✅ | 특정 태그 삭제 |
...
#### 태그 관련
- **라우터**: `backend/app/api/v1/tags.py`
- **서비스**: `backend/app/services/tag_service.py`
- **모델**: `backend/app/models/tag.py`
- **스키마**: `backend/app/schemas/tag.py`
...
#### 태그 관련
- **컴포넌트**: `frontend/src/components/tag/TagSelector.tsx`
- **업로드 페이지**: `frontend/src/pages/UploadVideo.tsx` (태그 선택)
- **상세 페이지**: `frontend/src/pages/VideoPlayer.tsx` (태그 편집)
- **리스트 페이지**: `frontend/src/pages/Videos.tsx` (태그 필터링)
...
- 태그 시스템: [6.v0.5-tag-system.md](./6.v0.5-tag-system.md) ⭐ NEW
